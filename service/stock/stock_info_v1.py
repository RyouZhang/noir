...
#     # lat lon cat_id, offset, limit
#     ret = await news_client(request)
#
#     return web.json_response(data=ret)
#
#
# async def update_news_info(request):
#
#     result = await news_update_client(request)
#     if result:
#         return web.Response(body=b"succeed")
#     else:
#         return web.Response(body=b'failed')
#
